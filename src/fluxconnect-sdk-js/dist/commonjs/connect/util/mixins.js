...
var mixins = function mixins(Parent) {
  for (var _len = arguments.length, mix = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
    mix[_key - 1] = arguments[_key];
  }
  ...
  for (var _iterator = mix, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
    var _ref;
